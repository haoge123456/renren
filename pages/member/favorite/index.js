    ...
    t.setData({
      ...
      e.get("member/favorite/get_list", {
        ...
        function (e) {
          ...
          e.list.length > 0 && (a.page = t.data.page + 1, a.list = t.data.list.concat(e.list), e.list.length < e.pagesize && (a.loaded = !0)),
            t.setData(a)
        })
  },
  ...
  btnClick: function (t) {
    ...
    if ("edit" == i) {
      ...
      var s = a.data.checkObj,
        ...
        l = [];
      for (var c in s) {
        if (typeof (s[c]) != 'undefined' && c != 'undefined') {
          s[c] && l.push(c);
        }
      }
      if (l.length < 1) return;
      e.confirm("删除后不可恢复，确定要删除吗？",
        function () {
