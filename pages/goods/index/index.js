...
Page({
  ...
  getList: function () {
    var t = this; t.setData({ loading: !0 }),
      t.data.params.page = t.data.page,
      t.data.params.brand = t.data.brandSelected;
  ...
  bindSort: function (t) {
    ...
    } else if ("minprice" == a) this.setData({ listorder: "" }),
      e.order == a ? "desc" == e.by ? e.by = "asc" : e.by = "desc" : e.by = "asc",
      e.order = a,
      this.setData({ listorder: e.by });
    else if ("sales" == a) {
      if (e.order == a) return; this.setData({ listorder: "" }),
  ...
  btnFilterBtns: function (t) {
    ...
    if (a) {
      var s = this.data.filterBtns; s.hasOwnProperty(a) || (s[a] = ""),
  ...
  bindCategoryEvents: function (t) {
    ...
    this.setData({ lastcat: a });
    var e = t.target.dataset.level;
    1 == e ? (this.setData({ category_child: [], category_third: [] }),
      this.setData({
        category_parent_selected: a,
        category_child: this.data.allcategory.children[a]
      })) : 2 == e ? (this.setData({ category_third: [] }),
        this.setData({
          category_child_selected: a,
          category_third: this.data.allcategory.children[a]
        })) : this.setData({ category_third_selected: a })
  },
  bindBrandEvents: function (t) {
    var a = t.currentTarget.dataset.id;
    this.setData({ brandSelected: a });
  },
  ...
  bindFocus: function (t) {
    "" == e.trim(t.detail.value) && this.setData({ fromsearch: !0 })
  },
  bindback: function () {
    wx.navigateBack()
  },
  ...
  setRecord: function (a) {
    if ("" != a) {
      ...
      if (e.isArray(s)) {
        var i = []; i.push(a);
        for (var r in s) { if (i.length > 20) break; s[r] != a && null != s && "null" != s && i.push(s[r]) } s = i
      } else s = [],
        s.push(a);
  ...
  setFocus: function () {
    var t = this;
    setTimeout(function () { t.setData({ focusin: !0 }) }, 1e3)
  }
})
